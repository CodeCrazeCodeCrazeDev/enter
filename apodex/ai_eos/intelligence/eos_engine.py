...
class EOSEngine:
    ...
    def ingest_validated_research(self, hypothesis: Any, experiment_result: Optional[Any] = None) -> None:
        """Ingest validated research hypothesis exported from Research OS."""
