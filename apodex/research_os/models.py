...
class BaseArtifact(BaseModel):
    """Base class for immutable scientific research artifacts."""
    ...
    def with_signature(self) -> BaseArtifact:
        """Sign or validate the artifact."""
        return self


class InstitutionalPolicy(BaseArtifact):
    """An institutional policy generated by self-improvement systems."""
    policy_name: str
    rules: List[str]


class ResearchProject(BaseArtifact):
    """A research project artifact."""
