...
class SkillRegistry:
    ...
    def _populate_default_skills(self) -> None:
        ...
        # 7 DECAYING skills (can be under domain="analytics" or others)
        decaying_skills = [
            "short_term_demand",
            "ad_velocity_check",
            "temporary_arbitrage",
        ...
        # Required remaining skills (43 evergreen skills)
        # Including 'structured_ab_testing', 'landing_page_patterns', 'revenue_metric_literacy'
        required_creatives = [
